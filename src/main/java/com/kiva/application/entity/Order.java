package com.kiva.application.entity;
                ...
                @SqlResultSetMapping(
                        ...
                        classes = @ConstructorResult(
                                ...
                                columns = {
                                        ...
                                        @ColumnResult(name = "product_name", type = String.class),
                                        @ColumnResult(name = "product_img", type = String.class),
                                        @ColumnResult(name = "payment", type = Integer.class),
                                        @ColumnResult(name = "shipping", type = String.class)
                                }
                        )
                )
        }
...
@NamedNativeQuery(
        ...
        query = "SELECT orders.id, orders.total_price, orders.size size_vn, product.name product_name, orders.price as product_price, " +
                "orders.receiver_name, orders.receiver_phone, orders.receiver_address, orders.status, orders.payment, orders.shipping, " +
