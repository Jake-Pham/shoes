package com.kiva.application.security;
...
public class ConfigInterceptor extends HandlerInterceptorAdapter {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (!authentication.getAuthorities().contains(new SimpleGrantedAuthority("ROLE_ANONYMOUS"))) {
            ...
            modelAndView.addObject("user_city", principal.getUser().getCity());
            modelAndView.addObject("user_district", principal.getUser().getDistrict());
            modelAndView.addObject("user_ward", principal.getUser().getWard());
